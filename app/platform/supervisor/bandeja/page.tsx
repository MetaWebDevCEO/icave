      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm">
            <a
              href="/platform/supervisor/bandeja?status=all"
              className={[
            ...
            <a
              href="/platform/supervisor/bandeja?status=pending"
              className={[
                "rounded-full px-3 py-1.5",
                statusFilter === "pending"
                  ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
            ...
            <a
              href="/platform/supervisor/bandeja?status=progress"
              className={[
                "rounded-full px-3 py-1.5",
                statusFilter === "progress"
                  ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
            ...
            <a
              href="/platform/supervisor/bandeja?status=completed"
              className={[
                "rounded-full px-3 py-1.5",
                statusFilter === "completed"
                  ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
        ...
        <div className="mt-4 rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
          <div className="flex flex-col gap-3 border-b border-zinc-200 px-5 py-4 dark:border-zinc-800 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-2 text-sm">
              <a
                href={`/platform/supervisor/bandeja?status=${statusFilter}&priority=all`}
                className={[
                  "rounded-full px-3 py-1.5",
                  priorityFilter === "all"
                    ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
              ...
              <a
                href={`/platform/supervisor/bandeja?status=${statusFilter}&priority=urgent`}
                className={[
                  "rounded-full px-3 py-1.5",
                  priorityFilter === "urgent"
                    ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
              ...
              <a
                href={`/platform/supervisor/bandeja?status=${statusFilter}&priority=medium`}
                className={[
                  "rounded-full px-3 py-1.5",
                  priorityFilter === "medium"
                    ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
              ...
              <a
                href={`/platform/supervisor/bandeja?status=${statusFilter}&priority=low`}
                className={[
                  "rounded-full px-3 py-1.5",
                  priorityFilter === "low"
                    ? "bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900"
